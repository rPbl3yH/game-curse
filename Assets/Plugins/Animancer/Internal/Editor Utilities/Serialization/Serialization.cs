...
// Shared File Last Modified: 2020-03-25.
...
// namespace UltEvents.Editor
{
    ...
    public static partial class Serialization
    {
        ...
        {
            Dictionary<string, PropertyAccessor> pathToAccessor;
        ...
        /// <summary>[Editor-Only]
        /// An <see cref="PropertyAccessor"/> for a particular element in an array.
        /// </summary>
        public class ArrayPropertyAccessor : PropertyAccessor
        {
            ...
            private static Type GetElementType(Type fieldType)
            {
                ...
                {
                    Debug.LogWarning("Serialization.ArrayPropertyAccessor: unable to determine element type for " + fieldType);
                    return fieldType;
                }
            }
            ...
            /// <summary>
            /// Gets the value of the from the <see cref="PropertyAccessor.Parent"/> (if there is one), then uses it to
            /// get and return the value of the <see cref="PropertyAccessor.Field"/>.
            /// </summary>
            ...
            /// <summary>
            /// Gets the value of the from the <see cref="PropertyAccessor.Parent"/> (if there is one), then uses it to
            /// set the value of the <see cref="PropertyAccessor.Field"/>.
            /// </summary>
