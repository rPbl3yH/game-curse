...
namespace Animancer
{
    partial class AnimancerState
    {
        ...
        /// </summary>
        public bool HasEvents { get { return _EventRunner != null; } }
        ...
        {
            get { return ObjectPool<EventRunner>.Count; }
        ...
        /// </summary>
        public static void SetMinEventPoolCount(int count)
        {
            ObjectPool<EventRunner>.SetMinCount(count);
        }
        ...
        {
            get { return ObjectPool<EventRunner>.Capacity; }
        ...
        private sealed class EventRunner : Key, IUpdatable
        {
            ...
            {
                var updatable = state._EventRunner;
                if (updatable != null)
                    return;
