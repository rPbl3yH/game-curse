...
namespace Animancer
{
    ...
    public class ControllerState : AnimancerState
    {
        ...
        {
            playable = Playable = AnimatorControllerPlayable.Create(Root._Graph, _Controller);
            ...
            where TState : ControllerState
        {
            ...
            public override bool IsValid { get { return _Controller != null; } }
            ...
            {
                return transition != null ? transition._Controller : null;
            }
        ...
        public class Transition : Transition<ControllerState>
        {
            ...
            {
                return new ControllerState(Controller, KeepStateOnStop);
            }
